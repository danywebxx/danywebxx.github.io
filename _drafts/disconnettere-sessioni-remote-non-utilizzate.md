...
Come può un malintenzionato `dirottare una sessione RDP` e prenderne il controllo? Se cercate su Google le parole `RDP hijacking` capirete che probabilmente è piu difficile da spiegare che farsi.
...
Mitigrare il problema non è particolarmente difficile se si applicano le giuste best-practices:
